seoul_districts = {
    "강남구": [
        ...
        "역삼1동", "역삼2동", "도곡1동", "도곡2동", "개포1동",
        "개포2동", "개포3동", "개포4동", "일원본동", "일원1동",
        "수서동", "세곡동"
    ],
    "강동구": [
        "강일동", "상일1동", "상일2동", "명일1동", "명일2동",
        "고덕1동", "고덕2동", "암사1동", "암사2동", "암사3동",
    ...
    "강서구": [
        ...
        "화곡1동", "화곡2동", "화곡3동", "화곡4동", "화곡6동",
        "화곡8동", "우장산동", "가양1동", "가양2동", "가양3동",
        "발산1동", "공항동", "방화1동", "방화2동", "방화3동"
    ],
    "관악구": [
    ...
    "도봉구": [
        "쌍문1동", "쌍문2동", "쌍문3동", "쌍문4동", "방학1동",
        "방학2동", "방학3동", "창1동", "창2동", "창3동",
        "창4동", "창5동", "도봉1동", "도봉2동"
    ],
    "동대문구": [
        "용신동", "제기동", "전농1동", "전농2동", "답십리1동",
        "답십리2동", "장안1동", "장안2동", "청량리동", "회기동",
        "휘경1동", "휘경2동", "이문1동", "이문2동"
    ],
    "동작구": [
    ...
    "성북구": [
        "돈암1동", "돈암2동", "보문동", "정릉1동", "정릉2동",
        "정릉3동", "정릉4동", "정릉5동", "길음1동", "길음2동",
        "장위1동", "장위2동", "장위3동", "석관동", "종암동", "안암동"
    ],
    "송파구": [
        "풍납1동", "풍납2동", "거여1동", "거여2동", "마천1동",
        "마천2동", "문정1동", "문정2동", "방이1동", "방이2동",
        "오륜동", "석촌1동", "석촌2동", "삼전동", "가락본동",
        "가락1동", "가락2동", "송파1동", "송파2동", "신천동"
    ],
    "양천구": [
        "신월1동", "신월2동", "신월3동", "신월4동", "신월5동",
        "신월6동", "신월7동", "신월8동", "신월9동", "신정1동", "신정2동"
    ],
    "영등포구": [
        "영등포본동", "영등포동", "여의동", "대림동",
        "신길1동", "신길2동", "신길3동", "신길4동",
        "문래1동", "문래2동", "당산1동", "당산2동", "당산3동"
    ],
    "용산구": [
        "효창동", "용산동", "이태원동", "한남동", "서계동",
        "원효로1동", "원효로2동", "청파동", "동자동", "보광동", "신계동"
    ],
    "은평구": [
        "응암1동", "응암2동", "응암3동", "응암4동",
        "역촌동", "불광1동", "불광2동", "수색동", "증산동"
    ],
    "종로구": [
        "사직동", "삼청동", "부암동", "평창동", "무악동",
        "교남동", "가회동", "종로1.2.3.4가동", "종로5.6가동",
        "이화동", "혜화동", "청운효자동", "신교동",
    ...
    "중랑구": [
        "면목2동", "면목3,8동", "면목4동", "면목5동", "면목7동",
        "상봉1동", "상봉2동", "중화1동", "중화2동",
        "묵1동", "묵2동", "신내1동", "신내2동", "망우본동"
    ]
}